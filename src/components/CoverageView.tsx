  ...
  return (
    <section className="coverage" aria-label="Reports by area">
      ...
      <p className="hint">
        ...
        Davis, and how that compares to roughly how much cycling happens there.
        Few or no reports in an area means it's <strong>under-reported</strong> —
        not that it's safe. Help close the gap by reporting what you see.
      </p>
