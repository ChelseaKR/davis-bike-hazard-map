      ...
      {duplicates.length > 0 && !confirmedExisting && (
        ...
        >
          <h2 className="dupe-nudge-title">
            <FormattedMessage id="report.dupe.title" defaultMessage="Already reported nearby?" />
          </h2>
          <p className="hint">
            <FormattedMessage
              id="report.dupe.body"
              defaultMessage="{count, plural, one {A similar hazard was reported close to here.} other {# similar hazards were reported close to here.}} Confirming an existing report (“I saw it too”) is more useful than filing a duplicate — it strengthens the one report the city sees."
