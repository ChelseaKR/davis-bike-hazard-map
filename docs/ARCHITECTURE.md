...
The canonical, append-only MADR log is [`docs/adr/`](./adr/). It contains the
full rationale, rejected alternatives, and consequences for each significant
decision. This document describes the resulting architecture and links to the
decision record instead of duplicating it.
